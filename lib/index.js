    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            return [2 /*return*/, new Promise(function (resolve, reject) {
                    interval_promise_1.default(function (iteration, stop) { return __awaiter(_this, void 0, void 0, function () {
...
module.exports = function (app) {
    ...
    app.on(['issue_comment.created', 'issue_comment.edited'], function (context) { return __awaiter(_this, void 0, void 0, function () {
        var failedTriggerPrComment, failedMergePrComment, res, body, _a, _b, prComment, status, err_2;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    if (!('comment' in context.payload && 'issue' in context.payload)) return [3 /*break*/, 11];
                    if (!context.payload.comment.body.match(/@git-watchman approve/gi)) return [3 /*break*/, 11];
