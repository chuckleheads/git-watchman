...
module.exports = function (app) {
    ...
    app.on(['issue_comment.created', 'issue_comment.edited'], function (context) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!('comment' in context.payload && 'issue' in context.payload)) return [3 /*break*/, 2];
                    if (!context.payload.comment.body.match(/@git-watchman approve/gi)) return [3 /*break*/, 2];
                    prComment = context.issue({ body: ':metal: I am testing your branch against #{pr.base.ref} before merging it. We do this to ensure that the master branch is never failing tests.' });
                    return [4 /*yield*/, context.github.issues.createComment(prComment)];
                case 1:
                    _a.sent();
                    _a.label = 2;
